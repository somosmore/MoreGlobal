...
const WEBINAR_SOURCE = "webinar-sep-26"
const WEBINAR_EVENT_LABEL =
  "Masterclass 1 — El nuevo panorama migratorio de EE.UU."
/** Etiqueta (tag) con la que se marcan los leads en GoHighLevel. */
const WEBINAR_GHL_TAG = "Webinar-Sep-26"
...
function SuccessCard({ variant }: { variant: WebinarSep26FormVariant }) {
  return <WSWhatsappJoinCard variant={variant} />
}
...
type WSRegistrationFormProps = {
  variant?: WebinarSep26FormVariant
}

export default function WSRegistrationForm({ variant = "default" }: WSRegistrationFormProps) {
  ...
  const { expired: isExpired } = useOfferWindow(settings.ws_registration_closes_at)
              ...
              <div className="p-6 sm:p-8">
                ...
                >
                  {submitting ? (
                    ...
                    <>
                      Sí, quiero mi lugar en la Masterclass 1
