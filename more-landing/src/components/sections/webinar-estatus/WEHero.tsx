      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 pt-24 pb-16 sm:px-6 lg:px-8 lg:pb-24">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-16">
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              ¿Cuál es tu estatus,{" "}
              <span className="text-[#F37021]">de verdad?</span>
            </motion.h1>
            ...
            >
              No necesitas memorizar todas las visas. Necesitas aprender a leer
              tu propia historia migratoria.
            </motion.p>
            ...
            >
              Muchas personas saben qué visa tienen… pero no saben qué dice su
              I-94, cuánto tiempo pueden permanecer, qué significa D/S, o qué
              diferencia hay entre una visa y un estatus.{" "}
              <strong className="font-semibold text-navy-deep">
                En este webinar en vivo vas a dejar de adivinar — y a entender
                qué está pasando con tu situación migratoria.
              </strong>
            </motion.p>
            ...
            >
              <CtaButton
                label="Sí, quiero entender mi situación migratoria"
                href="#registro"
        ...
        <EventCountdown targetDate={settings.we_event_date} tone="paper" />
      </div>
    </section>
  )
}
