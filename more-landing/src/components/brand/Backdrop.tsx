...
export const Backdrop = ({ variant = "hero", className }: BackdropProps) => {
    ...
    return (
      ...
      >
        <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="vip-dots-flat" width="22" height="22" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1.3" fill="#2A3A4A" />
            </pattern>
            <linearGradient id="vip-section-fade" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.35" />
              <stop offset="50%" stopColor="#FFFFFF" stopOpacity="0.12" />
              <stop offset="100%" stopColor="#FFFFFF" stopOpacity="0.35" />
            </linearGradient>
            <mask id="vip-section-mask">
              <rect x="0" y="0" width="100%" height="100%" fill="url(#vip-section-fade)" />
            </mask>
          </defs>
          <rect
            x="0"
            ...
            width="100%"
            height="100%"
            fill="url(#vip-dots-flat)"
            mask="url(#vip-section-mask)"
          />
        </svg>
      </div>
    )
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="vip-paper" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#FFFFFF" />
            <stop offset="45%" stopColor="#F6F7F9" />
            <stop offset="100%" stopColor="#FDF8F4" />
          </linearGradient>

          <linearGradient id="vip-wave-navy" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#4A6D96" />
            <stop offset="100%" stopColor="#1B2B44" />
          </linearGradient>
          <linearGradient id="vip-wave-navy-soft" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#C3D2E2" />
            <stop offset="100%" stopColor="#8AA4C1" />
          </linearGradient>

          <linearGradient id="vip-wave-orange" x1="1" y1="1" x2="0" y2="0">
            <stop offset="0%" stopColor="#E0561A" />
            <stop offset="100%" stopColor="#FF9052" />
          </linearGradient>
          <linearGradient id="vip-wave-orange-soft" x1="1" y1="1" x2="0" y2="0">
            <stop offset="0%" stopColor="#FFC9A6" />
            <stop offset="100%" stopColor="#FFE4D2" />
          </linearGradient>

          <pattern id="vip-dots" width="16" height="16" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r="1.4" fill="#2A3A4A" />
          </pattern>
          <radialGradient id="vip-dots-mask" cx="0.5" cy="0.35" r="0.6">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.5" />
            <stop offset="100%" stopColor="#000000" stopOpacity="0" />
          </radialGradient>
          <mask id="vip-dots-fade">
            <rect x="0" y="0" width="1440" height="560" fill="url(#vip-dots-mask)" />
          </mask>
        </defs>

        <rect x="0" y="0" width="1440" height="810" fill="url(#vip-paper)" />

        {/* Mapa evocado con retícula de puntos, desvaneciéndose hacia los bordes */}
        <g mask="url(#vip-dots-fade)" opacity="0.16">
          <rect x="0" y="0" width="1440" height="560" fill="url(#vip-dots)" />
        </g>

        {/* Ola navy — inferior izquierda */}
        <g>
          <path
            d="M0 470 C 130 452 236 528 330 612 C 404 678 452 748 476 810 L0 810 Z"
            fill="url(#vip-wave-navy-soft)"
            opacity="0.5"
          />
          <path
            d="M0 566 C 108 552 206 618 288 692 C 344 742 380 778 396 810 L0 810 Z"
            fill="url(#vip-wave-navy)"
            opacity="0.9"
          />
          <path
            ...
            opacity="0.85"
          />
          {/* Curvas de nivel: la textura fina del sistema impreso */}
        ...
        {/* Rutas migratorias: líneas punteadas, avión y pines */}
        <g>
          <path
