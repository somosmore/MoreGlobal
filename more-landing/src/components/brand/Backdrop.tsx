        ...
        >
          <defs>
            ...
            <linearGradient id={waveOrange} x1="1" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="var(--color-orange-deep)" />
              <stop offset="100%" stopColor="var(--color-orange-light)" />
            </linearGradient>
          </defs>

          <rect x="0" y="0" width="1440" height="420" fill="var(--color-navy-deep)" />
          ...
          <g fill="none" stroke="var(--color-navy-soft)" strokeWidth="1" opacity="0.18">
          ...
          <path
            ...
            opacity="0.5"
          />
          <g transform="translate(1268 46) rotate(-20) scale(1.4)" fill="var(--color-orange)" opacity="0.85">
        ...
        <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id={dots} width="22" height="22" patternUnits="userSpaceOnUse">
              <circle cx="2" cy="2" r="1.3" fill="var(--color-navy)" />
            </pattern>
      ...
      >
        <defs>
          ...
          <linearGradient id={waveNavySoft} x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="var(--color-navy-pale)" />
          ...
          <linearGradient id={waveOrangeSoft} x1="1" y1="1" x2="0" y2="0">
            <stop offset="0%" stopColor="var(--color-orange-pale)" />
            <stop offset="100%" stopColor="var(--color-orange-wash)" />
          </linearGradient>

          <pattern id={dots} width="16" height="16" patternUnits="userSpaceOnUse">
            <circle cx="2" cy="2" r="1.4" fill="var(--color-navy)" />
          </pattern>
        ...
        <g>
          ...
          <path
            ...
            opacity="0.85"
          />
          <g fill="none" stroke="var(--color-navy-line)" strokeWidth="1" opacity="0.35">
        ...
        <g>
          ...
          <path
            ...
            opacity="0.9"
          />
          <g fill="none" stroke="var(--color-orange-line)" strokeWidth="1" opacity="0.4">
        ...
        <g>
          ...
          <g transform="translate(1330 176) rotate(-28) scale(1.5)" fill="var(--color-orange)" opacity="0.9">
            <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z" />
          </g>
