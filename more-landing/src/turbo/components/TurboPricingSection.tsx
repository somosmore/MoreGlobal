      ...
      >
        <div className="overflow-hidden rounded-3xl border border-orange/20 bg-white shadow-xl">
          ...
          <div className="p-8 text-center">
            ...
            <div className="mt-5 rounded-xl bg-green-50 border border-green-100 px-4 py-4 text-left">
              <p className="text-xs font-semibold text-green-700 mb-3">Incluye:</p>
              <div className="space-y-2">
                {[
                  "Estrategia del caso personalizada",
                  "Declaración profesional revisada",
                  "4 cartas redactadas por MORE",
                  "Presentación ejecutiva + formas USCIS",
                  "Cover Letter + lista de Exhibits",
                  "Consolidación y envío digital a USCIS",
                ].map((item) => (
            ...
            <div className="mt-3 rounded-xl bg-red-50 border border-red-100 px-4 py-3 text-left">
              <p className="text-xs font-semibold text-red-600 mb-2">{notIncluded.title}</p>
              <div className="flex flex-wrap gap-2">
                {notIncluded.items.map((ni) => (
                  <span key={ni} className="inline-flex items-center gap-1 rounded-full border border-red-200 bg-white px-2.5 py-1 text-xs text-red-500">
