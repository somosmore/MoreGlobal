  ...
  return (
    <section className="grid gap-6 rounded-3xl bg-white p-6 text-navy shadow-sm ring-1 ring-gray-100 sm:grid-cols-2 sm:p-8">
      <div className="space-y-3">
        <h2 className="font-serif text-sm font-semibold uppercase tracking-[0.2em] text-orange/90">
      ...
      <div className="rounded-2xl bg-gray-50 p-5 ring-1 ring-gray-200/80">
        <h3 className="font-serif text-sm font-semibold uppercase tracking-[0.2em] text-gray-800">
